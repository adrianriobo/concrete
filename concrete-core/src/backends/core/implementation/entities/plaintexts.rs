use super::super::super::private::crypto::encoding::{
    Plaintext as CorePlaintext, PlaintextList as CorePlaintextList,
};
...
pub struct PlaintextVector32(CorePlaintextList<Vec<u32>>);
...
pub struct PlaintextVector64(CorePlaintextList<Vec<u64>>);
